...
<head>
    ...
    <link href="css/signuppage/signup-app.css" rel="stylesheet" type="text/css">
    ...
    <div class="container container-fluid main-content">
        <div class="row">
            ...
            <div class="m-scene" id="main">
                <div class="component col-md-8 col-xs-10 scene_element scene_element--fadeInRight" id="signup-form">
                    <form action="signup.php" method="POST" role="form" name="signup">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-9 col-sm-10">
                                        <input type="text" class="form-control" id="username" name="email" value = "<?php if($isFb){ echo $_SESSION['email_fb']; }?>" required>
                                    </div>
