...
//$mail->addAddress('ratik.bhatt12@gmail.com', "ACM Team");               // Name is optional

//$mail->addReplyTo('info@example.com', 'Information');
//$mail->addCC('ratik.bhatt12@gmail.com');
//$mail->addBCC('bcc@example.com');
...
//$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
    ...
    $mail->Body = 'Hello,<br>Suggestion submitted by user : '.$email.' was as follows:<br><br> " '.$body.' " <br><br>Thanks,
<br>WebDev Team, ACM-MAIT Student Chapter
<br>For queries / suggestions, mailto:suggestions@mait.acm.org
' ;
//$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
...
function send_tpp_abs_mail($abs_path,$res_path,$sender,$college,$email,$phone,$en_number,$notes){
 $mail = new PHPMailer;
...
//$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
    ...
    $mail->Body = '<br>PFA Abstract and Resume (if Attached) with the following details submitted in the form : <br> NAME: '.$sender.'<br>College: '.$college.'<br>Email: '.$email.'<br>Phone: '.$phone.'<br>Enrollment Number: '.$en_number.'<br>Additional Notes: '.$notes.'<br><br>Thanks,<br>ACM - MAIT Student Chapter' ;
//$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
